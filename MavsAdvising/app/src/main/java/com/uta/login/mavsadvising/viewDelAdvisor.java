...
public class viewDelAdvisor extends AppCompatActivity {
    ...
    List<DataModel_Advisor> modelItemList = new ArrayList<>();
        ...
        StringRequest stringReq = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    {
                        adapter.deleteObject(selectedItem);
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    for(int i=0;i< res.length();i++)
                    {
                        ...
                        modelItemList.add(new DataModel_Advisor(NetID,DayOfTheWeek,StartDate,EndDate,StartTime,EndTime));
                    }
                    adapter = new MyAdapter_Adv(viewDelAdvisor.this, modelItemList);
